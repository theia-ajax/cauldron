...
extern inline uint32_t hash_append(uint32_t hash, const uint8_t* bytes, size_t len);
extern inline uint32_t hash_data(const uint8_t* bytes, size_t len);
extern inline uint32_t hash_string(const char* str);
